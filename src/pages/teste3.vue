        ...
        <q-card square class="shadow-24" style="width:1300px;height:1248px;">
          ...
          <q-card-section>
            <q-form class="q-px-sm q-pt-xl q-pb-lg">
              <q-input square clearable v-model="text" label="nome">
                <template v-slot:prepend>
                  <q-icon name="person" />
                </template>
              </q-input>
              <q-input square clearable v-model="text" label="CPF">
                <template v-slot:prepend>
                  <q-icon name="picture_in_picture" />
                </template>
              </q-input>
              <q-input square clearable v-model="text" label="RG">
                <template v-slot:prepend>
                  <q-icon name="fingerprint" />
                </template>
              </q-input>
                 <q-input square clearable v-model="text" label="Orgão expedidor">
                <template v-slot:prepend>
                  <q-icon name="fact_check" />
                </template>
              </q-input>
                 <q-input square clearable v-model="text" label="Localização">
                <template v-slot:prepend>
                  <q-icon name="place" />
                </template>
              </q-input>
                 <q-input square clearable v-model="text" label="CEP">
                <template v-slot:prepend>
                  <q-icon name="home" />
                </template>
              </q-input>
                 <q-input square clearable v-model="text" label="cidade">
                <template v-slot:prepend>
                  <q-icon name="location_city" />
                </template>
              </q-input>
                 <q-input square clearable v-model="text" label="estado">
                <template v-slot:prepend>
                  <q-icon name="flag" />
                </template>
              </q-input>
                 <q-input square clearable v-model="date" type="date">
                <template v-slot:prepend>
                  <q-icon name="calendar_today" />
                </template>
              </q-input>
              <q-select id="sexo" square clearable v-model="model" :options="options" label="sexo" />
      ...
      />
         <q-input square clearable v-model="text" type="textarea" label="Especificações">
          ...
          <q-card-actions class="q-px-lg">
            <q-btn unelevated size="lg" color="teal-4" class="full-width text-white" label="cadastrar" />
          </q-card-actions>
          <q-card-section class="text-center q-pa-sm">
            <p class="text-grey-6">Volte para a paginad e Login </p>
          </q-card-section>
        </q-card>
      </div>
    </div>
